...
$query=mysqli_query($con,"select ManagerID from tblmanager where ManagerID='$mid' and   ManagerPass='$cpassword'");
...
$ret=mysqli_query($con,"update tblmanager set ManagerPass='$newpassword' where ManagerID='$mid'");

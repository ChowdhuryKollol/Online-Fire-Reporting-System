...
?>
                                ...
                                <a href="edit-team2.php?teamid=<?php echo $row['id'];?>&&tname=<?php echo $row['teamName'];?>" class="btn-sm btn-primary">Edit</a> 

                                <a href="manage-teams2.php?teamid=<?php echo $row['id'];?>" onclick="return confirm('Do you really want to delete the team?');" class="btn-sm btn-danger">Delete</a></td>
                                        </tr>
                               <?php $cnt++;
                           } ?>
                                    </tbody>

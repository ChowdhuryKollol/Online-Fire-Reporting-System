...
if(isset($_POST['submit']))
  {
    ...
    $password=md5($_POST['newpassword']);
        ...
        $query=mysqli_query($con,"update tblmanager set ManagerPass='$password'  where  ManagerEmail='$email' && ManagerContact='$contactno' ");
   if($query)
   {
echo "<script>alert('Password successfully changed for Manager');</script>";

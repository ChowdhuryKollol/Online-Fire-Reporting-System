...
$query5=mysqli_query($con,"select ManagerID from tblmanager");
$totalmanager=mysqli_num_rows($query5);
?>
...
<div class="col-xl-12 col-md-12 mb-3">
     ...
     <div class="col-xl-12 col-md-12 mb-4">
                        ...
                        <div class="col-xl-12 col-md-12 mb-4">
                            <div class="card border-left-secondary border-secondary shadow h-100">
                                <a href="managermanage.php">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
 
                                            <div class="text-x  font-weight-bold text-secondary text-uppercase mb-1" style="margin-left:;">
                                             Manager List</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $totalmanager;?></div>
                                        </div>
                                        <div class="col-auto">
